(ns marketentry.phase
  "Phase 0->3 staged rollout for the Saint Lucia (LCA) market-entry
  compliance actor.
  ...
  real portal package and submitting a real Central Public Procurement
  Board portal registration are the two real-world acts this actor
